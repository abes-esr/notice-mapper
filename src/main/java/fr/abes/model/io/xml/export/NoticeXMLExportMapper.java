...
@Component
@Slf4j
public class NoticeXMLExportMapper {
     ...
     */
    @Bean
    public void converterXMLNoticeExportNoticePeriodique() {

        Converter<NoticeXMLExport, NoticePeriodique> myConverter = new Converter<NoticeXMLExport, NoticePeriodique>() {

            public NoticePeriodique convert(MappingContext<NoticeXMLExport, NoticePeriodique> context) {
                NoticeXMLExport source = context.getSource();
