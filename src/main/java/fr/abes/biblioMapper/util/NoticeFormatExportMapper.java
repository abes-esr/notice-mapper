...
import fr.abes.biblioMapper.entity.donneesCodees.TypeRessourceContinue;
import fr.abes.biblioMapper.entity.donneesCodees.AnneePublication;
import fr.abes.biblioMapper.entity.donneesCodees.TypeSupport;
import fr.abes.biblioMapper.entity.etatCollection.*;
import fr.abes.biblioMapper.entity.xml.DataField;
import fr.abes.biblioMapper.entity.xml.NoticeXml;
import fr.abes.biblioMapper.entity.xml.SubField;
import fr.abes.biblioMapper.exception.IllegalDateException;
import fr.abes.biblioMapper.exception.IllegalHoldingException;
import fr.abes.biblioMapper.exception.IllegalPublicationYearException;
import fr.abes.biblioMapper.exception.MissingFieldException;
...
public class NoticeFormatExportMapper {
    ...
    public void converterNoticeXML() {
        ...
        Converter<NoticeXml, RessourceContinue> myConverter = new Converter<NoticeXml, RessourceContinue>() {

            public RessourceContinue convert(MappingContext<NoticeXml, RessourceContinue> context) {
                NoticeXml source = context.getSource();
                RessourceContinue target = new RessourceContinue();
                int maxPass = 1;
                try {
